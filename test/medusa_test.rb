...
class MedusaTest < Minitest::Test
  ...
  def test_can_only_have_three_victims
    ...
    victim_2 = Person.new("Cassius")
    victim_3 = Person.new("Poseidon")
    victim_4 = Person.new("Athena")

    medusa.stare(victim_1)
    assert_equal medusa.statues.count, 1

    medusa.stare(victim_2)
    assert_equal medusa.statues.count, 2
